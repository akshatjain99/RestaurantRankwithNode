...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    var isHearted = _this.heart.classList.toggle('heart__button--hearted'); //toggle the hearts red and white
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    //create bounds for the map to zoom in
    ...
    //when somebody clicks on the marker, show thm infowindow
    ...
    // zoom the map so that everything fits
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios.get('/api/search/?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = dompurify.sanitize('<div class=\'search__result\'>No Result found for ' + _this.value + '</div>');
    });
  });
